...
function getFonts()
{
	...
	if ($imbalance2_theme_options['font'] == 0) return 'Arial, "Sans-Serif"';
...
function getlogo()
{
	...
	return '<a href="'.home_url( '/' ).'" alt=""> <img src="'.($imbalance2_theme_options['logo'] != '' ? $imbalance2_theme_options['logo'] : get_bloginfo('stylesheet_directory').'/images/logo.png').'" /> <a>';
}
...
function getColor()
{
	...
	return $imbalance2_theme_options['color'] != '' ? $imbalance2_theme_options['color'] : '#e25119';
}
