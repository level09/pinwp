...
<div id="header">
            <div id="search">
			<?php get_search_form(); ?>
<!--			<div id="header-right"><?php wp_nav_menu( array( 'container_class' => 'menu', 'theme_location' => 'header-right', 'walker' => new pin_board_Walker_Nav_Menu(), 'depth' => 1 ) ); ?></div>-->
		</div>
...
//                            }
        ...
        <div id="header_banner">
            ...
            <span class="header_banner_mid">
                <h1>Subscribe for Pinterest Theme <span>Organize and share things you love</span></h1>
<!--                <div id="header_banner_btn"><span><a href="<?php echo wp_login_url( $redirect ).'?action=register'; ?>">Register >></a></span><span><a href="<?php echo wp_login_url( $redirect ); ?>">Login </a></span></div>-->
    ...
    <div style="clear: both;padding-bottom: 170px;"></div>
